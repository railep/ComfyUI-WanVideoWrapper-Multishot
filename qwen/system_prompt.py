...
# Mapping list for all system prompts, with human-readable labels
SYSTEM_PROMPT_MAP = [
    {"key": "T2V_A14B_ZH_SYS_PROMPT", "label": "T2V Movie Director (Chinese)", "prompt": T2V_A14B_ZH_SYS_PROMPT},
    {"key": "T2V_A14B_EN_SYS_PROMPT", "label": "T2V Movie Director (English)", "prompt": T2V_A14B_EN_SYS_PROMPT},
    {"key": "I2V_A14B_ZH_SYS_PROMPT", "label": "I2V Rewriter (Chinese)", "prompt": I2V_A14B_ZH_SYS_PROMPT},
    {"key": "I2V_A14B_EN_SYS_PROMPT", "label": "I2V Rewriter (English)", "prompt": I2V_A14B_EN_SYS_PROMPT},
    {"key": "I2V_A14B_EMPTY_ZH_SYS_PROMPT", "label": "I2V Imagination (Chinese)", "prompt": I2V_A14B_EMPTY_ZH_SYS_PROMPT},
    {"key": "I2V_A14B_EMPTY_EN_SYS_PROMPT", "label": "I2V Imagination (English)", "prompt": I2V_A14B_EMPTY_EN_SYS_PROMPT},
]
